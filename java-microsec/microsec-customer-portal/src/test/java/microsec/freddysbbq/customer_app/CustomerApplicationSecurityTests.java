...
public class CustomerApplicationSecurityTests extends SecurityIntegrationTest {
    ...
    @Test
    public void testCatalogSecurity() throws Exception {
        checkRequiresHttpsAndOauthSso("/catalog", ssoProperties.getLoginPath());
    }

    @Test
    public void testCatalogOrdersSecurity() throws Exception {
        checkRequiresHttpsAndOauthSso("/catalog-orders", ssoProperties.getLoginPath());
    }
